        ...
        <Card className="shadow-lift border-0">
          <CardHeader className="text-center">
            <CardTitle className="flex items-center justify-center space-x-2">
              <Leaf className="text-primary animate-bounce-gentle" />
              <span>Welcome Back</span>
            </CardTitle>
            <CardDescription>
              Exchange books, save the planet, earn rewards
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
              ...
              <TabsContent value="signup" className="space-y-4 mt-6">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button 
                    ...
                    disabled={isLoading}
                  >
                    {isLoading ? "Creating account..." : "Join Bookhive"}
                  </Button>
                </form>
              </TabsContent>
            </Tabs>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-muted-foreground">
                By joining, you're helping reduce book waste and building a sustainable reading community
              </p>
            </div>
          </CardContent>
        </Card>
